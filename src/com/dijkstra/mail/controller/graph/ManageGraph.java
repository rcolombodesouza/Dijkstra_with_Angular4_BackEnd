...
public class ManageGraph {
    ...
    /**
     * Iterates a map to create the graph and creates the path from / to with their hard cost. Helps the mountGraph
     * function
     * @param subEntry
     * @param graph
     * @param from
     */
    private static void iterateSubMap(Map.Entry<String, String> subEntry, GraphBuilder<String,Integer> graph,
            String from){
